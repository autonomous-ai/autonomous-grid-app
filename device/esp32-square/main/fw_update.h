...
//
// What was taken from the reference (autonomous-code/apps/esp32-square-s3/main/ota.c) is the half that
...
// grid-app is offering an image. The panel decides, and a `no` is silence: docs/protocol.md §2 says
