...
//
// The panel captures and the app transcribes (docs/protocol.md §2, "Voice"). This device holds no cloud
...
// autonomous-code/apps/esp32-square-s3/main/audio_client.c does this job over a TLS websocket on flaky
