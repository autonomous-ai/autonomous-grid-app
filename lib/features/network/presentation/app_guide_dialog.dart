...
/// Explains how to point a local AI app at this grid — but as a *task*, not a
/// wall of config. The user picks their app (auto-selected if we detect it
/// installed); we show only that app's setup, offer to write the config for
/// them ("Apply for me"), or a Download button when the app is missing. "Other
/// app" falls back to the raw OpenAI-compatible values for anything we don't
/// know. Takes the grid's real relay BASE_URL / API_KEY, pre-filled everywhere.
class AppGuideDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AppGuideDialog> createState() => _AppGuideDialogState();
}

class _AppGuideDialogState extends ConsumerState<AppGuideDialog> {
      ...
      content: ConstrainedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text(
                'This grid works like one AI provider. Pick the app you want to '
                'use it in — Grid can fill in the connection for you.',
                style: TextStyle(
