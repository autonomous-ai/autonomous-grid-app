    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          // What the user has already said outranks everything else here:
          // these are a request in the making, and the row that sends it is
          // the only one that has to be found without looking.
