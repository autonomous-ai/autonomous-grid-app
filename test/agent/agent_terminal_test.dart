...
void main() {
  group(
    'claudePermissionArgs — the composer, as the interactive CLI takes it',
    () {
      test(
        'full access is the mode the user chose, so it is named outright',
        () {
      ...
      test(
        'look-don\'t-touch and ask-first pass no mode at all: the interactive '
        'CLI\'s own default gate is already the asking one, and naming a mode '
        'this build may not accept would fail the session before it drew',
        () {
