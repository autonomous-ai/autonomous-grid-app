...
void main() {
  ...
  group(
    'needsCompaction — the app asking the ceiling it already handed over',
    () {
      ...
      test('a session at the ceiling makes room first', () {
        expect(
          needsCompaction(usedTokens: 160000, engineWindow: 200000),
          isTrue,
        );
      });
      ...
      test('the turn that was actually refused would have been caught', () {
        ...
        expect(
          needsCompaction(usedTokens: 230145, engineWindow: 200000),
          isTrue,
        );
      });

      test(
        'a session that has reported nothing yet is left alone — no figure is '
